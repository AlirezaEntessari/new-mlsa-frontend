        ...
        <div className="help-home-page__right-container">
          <div className="help-home-page__mobile-container">
            ...
            <div className="help-home-page__mobile-card-container">
              <Link
                className="help-home-page__mobile-card-link"
              ...
              >
                <div className="help-home-page__mobile-glossary-container">
                  <img
                    ...
                    alt="Glossary Icon"
                  />
                  <p className="help-home-page__mobile-glossary-text">
                    Glossary
                  </p>
          ...
          <div className="help-home-page__tablet-container">
            ...
            <div className="help-home-page__tablet-central-card-container">
              <div className="help-home-page__tablet-my-account-job-posting-container">
                <Link
                  className="help-home-page__tablet-card-link"
                  to="/help-my-account-page"
                >
                ...
                >
                  <div className="help-home-page__tablet-reports-container">
                    <img
                      ...
                      alt="Reports Icon"
                    />
                    <p className="help-home-page__tablet-reports-text">
                      Reports
                    </p>
              ...
              >
                <div className="help-home-page__tablet-glossary-container">
                  <img
                    ...
                    alt="Glossary Icon"
                  />
                  <p className="help-home-page__tablet-glossary-text">
                    Glossary
                  </p>
          ...
          <div className="help-home-page__desktop-container">
            ...
            <div className="help-home-page__desktop-central-container">
              <div className="help-home-page__desktop-my-account-job-posting-candidate-posting-container">
                <Link className="help-home-page__desktop-card-link" to="/help-my-account-page">
                ...
                <Link className="help-home-page__desktop-card-link" to="/help-job-posting-page">
                ...
                <Link className="help-home-page__desktop-card-link" to="/help-candidate-posting-page">
              ...
              <div className="help-home-page__desktop-documents-partnerships-dashboard-container">
                <Link className="help-home-page__desktop-card-link" to="/help-documents-page">
                ...
                <Link className="help-home-page__desktop-card-link" to="/help-partnerships-page">
                ...
                <Link className="help-home-page__desktop-card-link" to="/help-dashboard-page">
              ...
              <div className="help-home-page__desktop-searching-ratings-and-feedback-reports-container">
                <Link className="help-home-page__desktop-card-link" to="/help-searching-page">
                ...
                <Link className="help-home-page__desktop-card-link" to="/help-ratings-and-feedback-page">
                ...
                <Link className="help-home-page__desktop-card-link" to="/help-reports-page">
              ...
              <div className="help-home-page__desktop-membership-policies-and-terms-faq-container">
                <Link className="help-home-page__desktop-card-link" to="/help-membership-page">
                ...
                <Link className="help-home-page__desktop-card-link" to="/help-policies-and-terms-page">
                ...
                <Link className="help-home-page__desktop-card-link" to="/help-faq-page">
              ...
              <Link className="help-home-page__desktop-card-link" to="/help-glossary-page">
