  ...
  return (
    <div className="login">
      ...
      <p className="login__keep-me-signed-in">
        ...
        <span className="login__forgot-your-password-text">Forgot your password?</span>
      </p>
      <img className="login__reCAPTCHA-icon" src={reCAPTCHAIcon} alt="reCAPTCHA Icon" />
      <button className="login__enter-button">Enter</button>
      <p className="login__dont-have-an-account">Don't have an account? <span className="login__sign-up-text">Sign Up</span></p>
    </div>
  );
}
