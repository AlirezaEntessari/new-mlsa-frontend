...
import "./SearchAgenciesRatingsPage.scss";
...
export default function SearchAgenciesRatingsPage() {
  ...
  return (
    <div className="search-agencies-ratings-page">
      <HeaderWithProfilePic />
      <div className="search-agencies-ratings-page__main-container">
        <AgenciesSidePanel />
        <div className="search-agencies-ratings-page__right-container">
          <p className="search-agencies-ratings-page__header">
            Search Agencies
          </p>
          <div className="search-agencies-ratings-page__button-container">
            <button
              className={`search-agencies-ratings-page__all-agencies-button ${getButtonClass(
                "all-agencies"
              )}`}
              onClick={() =>
                handleButtonClick(
          ...
          />
          <input
            className="search-agencies-ratings-page__keyword-search-input"
            type="text"
            placeholder="Keyword Search"
          />
          <div className="search-agencies-ratings-page__sort-by-agency-name-container">
            <span className="search-agencies-ratings-page__sort-by-text">
              Sort by:
            </span>
            <span className="search-agencies-ratings-page__agency-name-text">
              Agency Name
            </span>
            <img
              className="search-agencies-ratings-page__menu-circle-arrow-gray-icon"
              src={MenuCircleArrowGrayIcon}
              alt="Menu Circle Arrow Gray Icon"
            />
          </div>
          <div className="search-agencies-ratings-page__mobile-card-container">
