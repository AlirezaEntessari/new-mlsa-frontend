      ...
      <div className="account-settings-password__main-container">
        ...
        <div className="account-settings-password__right-container">
          ...
          <p className="account-settings-password__rules-length">
            <span className="account-settings-password__bold">1. Length: </span>
          ...
          />
          <button className="account-settings-password__cancel-button">Cancel</button>
          <button className="account-settings-password__save-changes-button">Save Changes</button>
        </div>
      </div>
    </div>
  );
