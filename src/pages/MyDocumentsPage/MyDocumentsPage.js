    ...
    <div className="my-documents-page">
      ...
      <div className="my-documents-page__main-container">
        ...
        <div className="my-documents-page__right-container">
          ...
          <div className="my-documents-page__tablet-row-containers">
            <div className="my-documents-page__tablet-white-row-container">
              <img
                className="my-documents-page__pdf-logo-small"
                src={PDFLogo}
                alt="PDF Logo"
              />
              <span className="my-documents-page__tablet-white-row-text">
                7894982765758_Connor Matthews NDA_signed_2024
              </span>
              <img
                className="my-documents-page__white-row-checkbox-empty-icon"
                src={CheckBoxEmptyIcon}
                alt="Checkbox Empty Icon"
              />
            </div>
            <div className="my-documents-page__tablet-gray-row-container">
              <img
                className="my-documents-page__pdf-logo-small"
                src={PDFLogo}
                alt="PDF Logo"
              />
              <span className="my-documents-page__tablet-gray-row-text">
                9347469298757_John Smith NDA_signed_2024
              </span>
              <img
                className="my-documents-page__gray-row-checkbox-empty-icon"
                src={CheckBoxEmptyIcon}
                alt="Checkbox Empty Icon"
              />
            </div>
          ...
          <div className="my-documents-page__page-number-container">
            <img
              className="my-documents-page__page-arrow-left-icon"
              src={PageArrowLeftIcon}
              alt="Page Arrow Left Icon"
            />
            <img
              className="my-documents-page__page-number-peach-1-icon"
              src={PageNumberPeach1Icon}
              alt="Page Number Peach 1 Icon"
            />
            <img
              className="my-documents-page__page-number-gray-2-icon"
              src={PageNumberGray2Icon}
              alt="Page Number Gray 2 Icon"
            />
            <img
              className="my-documents-page__page-number-gray-3-icon"
              src={PageNumberGray3Icon}
              alt="Page Number Gray 3 Icon"
            />
            <img className="my-documents-page__page-arrow-right-icon" src={PageArrowRightIcon} alt="Page Arrow Right Icon" />
          </div>
        </div>
      </div>
    </div>
