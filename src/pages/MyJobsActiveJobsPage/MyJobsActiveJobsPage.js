...
import "./MyJobsActiveJobsPage.scss";
...
export default function MyJobsActiveJobsPage() {
  return (
      ...
      <div className="my-jobs-home-page__main-container">
        ...
        <div className="my-jobs-home-page__right-container">
          ...
          <div className="my-jobs-home-page__all-jobs-container">
            ...
            <p className="my-jobs-home-page__all-jobs-active-jobs">Active Jobs</p>
          ...
          <p className="my-jobs-home-page__tablet-active-jobs-header">Active Jobs</p>
