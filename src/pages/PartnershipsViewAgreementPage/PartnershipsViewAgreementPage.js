        ...
        <div className="partnerships-view-agreement-page__right-container">
          <div className="partnerships-view-agreement-page__mobile-container">
            ...
            <div className="partnerships-view-agreement-page__mobile-content-container">
              ...
              <p className="partnerships-view-agreement-page__desktop-by-following-these-instructions">
              ...
              <p className="partnerships-view-agreement-page__desktop-partnership-agreement-header">
                Partnership Agreement
              </p>
              <p className="partnerships-view-agreement-page__desktop-partnership-agreement-description">
              ...
              <div className="partnerships-view-agreement-page__desktop-purpose-container">
                <p className="partnerships-view-agreement-page__desktop-purpose-header">
                  1.{" "}
                  <span className="partnerships-view-agreement-page__desktop-extra-space">
                    Purpose
                  </span>
                </p>
                <p className="partnerships-view-agreement-page__desktop-purpose-description">
              ...
              <div className="partnerships-view-agreement-page__desktop-responsibilities-of-the-parties-container">
                <p className="partnerships-view-agreement-page__desktop-responsibilities-of-the-parties-header">
                  2.{" "}
                  <span className="partnerships-view-agreement-page__desktop-extra-space">
                    Responsibilities of the Parties
                  </span>
                </p>
                <p className="partnerships-view-agreement-page__desktop-responsibilities-of-the-parties-description-agency-1">
                  -**[Agency 1 Name].** [Agency 1 Name] agrees to provide
                  [specific services, resources, or contributions] as part of
                  this partnership.
                </p>
                <p className="partnerships-view-agreement-page__desktop-responsibilities-of-the-parties-description-agency-2">
                  -**[Agency 2 Name].** [Agency 2 Name] agrees to provide
                  [specific services, resources, or contributions] as part of
                  this partnership.
                </p>
              </div>
              <div className="partnerships-view-agreement-page__desktop-term-container">
                <p className="partnerships-view-agreement-page__desktop-term-header">
                  3. <span className="cccc">Term</span>
                </p>
                <p className="partnerships-view-agreement-page__desktop-term-description">
              ...
              <div className="partnerships-view-agreement-page__desktop-confidentiality-container">
                <p className="partnerships-view-agreement-page__desktop-confidentiality-header">
                  4.{" "}
                  <span className="partnerships-view-agreement-page__desktop-extra-space">
                    Confidentiality
                  </span>
                </p>
                <p className="partnerships-view-agreement-page__desktop-confidentiality-description">
              ...
              <div className="partnerships-view-agreement-page__desktop-profit-sharing-container">
                <p className="partnerships-view-agreement-page__desktop-profit-sharing-header">
                  5.{" "}
                  <span className="partnerships-view-agreement-page__desktop-extra-space">
                    Profit Sharing
                  </span>
                </p>
                <p className="partnerships-view-agreement-page__desktop-profit-sharing-description">
              ...
              <div className="partnerships-view-agreement-page__desktop-termination-container">
                <p className="partnerships-view-agreement-page__desktop-termination-header">
                  6.{" "}
                  <span className="partnerships-view-agreement-page__desktop-extra-space">
                    Termination
                  </span>
                </p>
                <p className="partnerships-view-agreement-page__desktop-termination-description">
              ...
              <div className="partnerships-view-agreement-page__desktop-governing-law-container">
                <p className="partnerships-view-agreement-page__desktop-governing-law-header">
                  7.{" "}
                  <span className="partnerships-view-agreement-page__desktop-extra-space">
                    Governing Law
                  </span>
                </p>
                <p className="partnerships-view-agreement-page__desktop-governing-law-description">
                  This Agreement shall be governed by and construed in
                  accordance with the laws of the State of [State], without
                  regard to its conflict of laws principles.
                </p>
              </div>
              <div className="partnerships-view-agreement-page__desktop-entire-agreement-container">
                <p className="partnerships-view-agreement-page__desktop-entire-agreement-header">
                  8.{" "}
                  <span className="partnerships-view-agreement-page__desktop-extra-space">
                    Entire Agreement
                  </span>
                </p>
                <p className="partnerships-view-agreement-page__desktop-entire-agreement-description">
              ...
              <div className="partnerships-view-agreement-page__desktop-amendments-container">
                <p className="partnerships-view-agreement-page__desktop-amendments-header">
                  9.{" "}
                  <span className="partnerships-view-agreement-page__desktop-extra-space">
                    Amendments
                  </span>
                </p>
                <p className="partnerships-view-agreement-page__desktop-amendments-description">
                  This Agreement may be amended or modified only in writing,
                  signed by both Parties.
                </p>
              </div>
              <div className="partnerships-view-agreement-page__desktop-miscellaneous-container">
                <p className="partnerships-view-agreement-page__desktop-miscellaneous-header">
                  10.{" "}
                  <span className="partnerships-view-agreement-page__desktop-extra-space">
                    Miscellaneous
                  </span>
                </p>
                <p className="partnerships-view-agreement-page__desktop-miscellaneous-description-line-1">
                ...
                <p className="partnerships-view-agreement-page__desktop-miscellaneous-description-line-2">
              ...
              <p className="partnerships-view-agreement-page__desktop-terms-and-conditions-for-accepting-to-partner-with-header">
                Terms and Conditions for Accepting to Partner with Staffing
                Agency
              </p>
              <p className="partnerships-view-agreement-page__desktop-terms-and-conditions-for-accepting-to-partner-with-description">
