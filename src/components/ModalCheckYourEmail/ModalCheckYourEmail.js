...
export default function ModalCheckYourEmail({ closeModal }) {
  return (
    <div className="modal-check-your-email">
      <div className="modal-check-your-email__overlay" onClick={closeModal}>
        ...
        >
          ...
          <label className="modal-check-your-email__validation-code-label" htmlFor="validation-code">Validation Code</label>
          <input className="modal-check-your-email__validation-code-input" type="text" id="validation-code" placeholder="Enter the validation code from the email" />
          <button className="modal-check-your-email__continue-button">Continue</button>
        </div>
      </div>
    </div>
  );
